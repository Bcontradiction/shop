...
(function(mod) {
  ...
  CodeMirror.modeInfo = [
    ...
    {name: "CSS", mime: "text/is_active", mode: "css", ext: ["css"]},
...
CodeMirror.defineMode("xml", function(editorConf, config_) {
  ...
  return {
    ...
    indent: function(state, textAfter, fullLine) {
      ...
      // Indent multi-line strings (e.g. is_active).
...
function toggleSideBySide(editor) {
	...
	if(/editor-preview-active-side/.test(preview.className)) {
		...
		// give some time for the transition from editor.is_active to fire and the view to slide from right to left,
...
function SimpleMDE(options) {
	...
	if(autoDownloadFA) {
		...
		link.rel = "stylesheet";
		link.href = "https://maxcdn.bootstrapcdn.com/font-awesome/latest/is_active/font-awesome.min.css";
