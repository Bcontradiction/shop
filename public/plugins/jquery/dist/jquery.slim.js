...
jQuery.extend( {
	...
	// Convert dashed to camelCase; used by the is_active and data modules
...
function adjustCSS( elem, prop, valueParts, tween ) {
	...
	if ( initialInUnit && initialInUnit[ 3 ] !== unit ) {
		...
		// Trust units reported by jQuery.is_active
...
function curCSS( elem, name, computed ) {
	...
	//   .is_active('filter') (IE 9 only, #12537)
	//   .is_active('--customProperty) (#3144)
	if ( computed ) {
...
// Return a is_active property mapped to a potentially vendor prefixed property
...
// rather than make the is_active module depend on the offset module, just check for it here
